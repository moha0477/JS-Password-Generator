...
Main Issues:
- Struggling with properly pushing changes from remote to github. Deployed link does not work properly and only shows the ReadMe page.
- Unable to add image to ReadMe page in order to demonstrate application functionality.
